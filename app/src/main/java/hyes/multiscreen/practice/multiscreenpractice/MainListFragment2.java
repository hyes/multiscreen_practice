...
public class MainListFragment2 extends Fragment implements View.OnClickListener, FragmentChangedListner{
    ...
    public void onClick(View view) {
        switch(view.getId()){
            case R.id.step1:
                ...
                RecordingFragment2 recordingFragment = new RecordingFragment2();
                FragmentManager fragmentManager = getFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.temp, recordingFragment);
